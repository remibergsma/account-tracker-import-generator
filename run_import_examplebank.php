...
// This class processess the ExampleBank export file and creates
// a csv file that can be imported to the Account Tracker iPad app.

// Script to handle Example Bank.
...
require './inc/createIpadImportExampleBank.class.php';
...
// init class
$asn = new createIpadImportExampleBank (
				$bank_name,
